            ...
            <div className="section">
              <div className="call-to-action">
                ...
                <div>
                  Volunteer
                  <ul>
                    <li><Link to="/volunteer">> I WANT TO SEW MASKS</Link></li>
                    <li><a href="https://rosiesews.freshdesk.com/support/solutions/articles/61000260572-i-don-t-know-how-to-sew-can-i-still-help-">> I CAN'T SEW, BUT I WANT TO HELP</a></li>
                  </ul>
                </div>
              </div>

              <div className="ribbon"><h1>After You Sign Up</h1></div>
              ...
              <div className="call-to-action">
                ...
                <div>
                  Get the Pattern
                  <ul>
                    <li><a href="/docs/CFCMask_3_27.pdf">> 3-LAYER FACE MASK</a></li>
                    <li><a href="/docs/CFC_Pocket_Mask_3_28.pdf">> POCKET FACE MASK</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="call-to-action">
                ...
                <div>
                  Make Masks
                  <ul>
                    <li><a href="https://www.youtube.com/watch?v=J0HnaWUIyzg">> WATCH 3-LAYER MASK VIDEO</a></li>
                    <li><a href="https://www.youtube.com/watch?v=6NI8W5N06xo">> WATCH POCKET MASK VIDEO</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="call-to-action">
                ...
                <div>
                  ...
                  <Link to="/groups-directory">
                    <ul>
                      <li>YOUR STATE LEAD WILL EMAIL YOU WITH DIRECTIONS ON HOW & WHERE</li>
                    </ul>
                  </Link>
                </div>
              </div>
              ...
              <div className="call-to-action">
                ...
                <div>
                  ...
                  <a href="https://rosiesews.freshdesk.com/support/home">
                    <ul>
                      <li>FIND ANSWERS TO ALL YOUR QUESTIONS AT OUR KNOWLEDGE BASE</li>
                    </ul>
                  </a>
                </div>
              </div>
